document.addEventListener('DOMContentLoaded', () => {
                ...
                productCard.innerHTML = `
                    ...
                    <img src="${product.imagen_principal}" class="card-img-top" alt="${product.titulo}" style="width: 200px; height: 300px;">
                        ...
                        <div class="card-body">
                            ...
                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editProductModal" data-id="${product.id_productos}">Editar</button>
                        </div>
                    </div>
                `;
    ...
    async function loadProductDetails(productId) {
        try {
            ...
            document.getElementById('editProductId').value = product.id_productos;
    ...
    editProductForm.addEventListener('submit', async event => {
        ...
        const productId = formData.get('id_productos');
